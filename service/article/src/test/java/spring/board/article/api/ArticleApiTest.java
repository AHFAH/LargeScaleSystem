package spring.board.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(191555051877576704L);
        System.out.println("response = " + response);
    }
    ...
    @Test
    void countTest() {
        ArticleResponse response = create(new ArticleCreateRequest("hi", "content", 1L, 3L));

        Long count1 = restClient.get()
                .uri("/v1/articles/boards/{boardId}/count", 3L)
                .retrieve()
                .body(Long.class);
