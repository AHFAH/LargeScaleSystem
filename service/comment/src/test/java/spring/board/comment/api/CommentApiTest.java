...
public class CommentApiTest {
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v1/comments/{commentId}", 196992659114663936L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    void delete() {
        restClient.delete()
                .uri("/v1/comments/{commentId}", 196992401743781888L)
                .retrieve();
    }
    ...
    /*
        ...
        comment.getCommentId() = 196999227472322560
        comment.getCommentId() = 196999227472322561
        comment.getCommentId() = 196999227472322562
        comment.getCommentId() = 196999227472322563
        comment.getCommentId() = 196999227472322564
        comment.getCommentId() = 196999227472322565
        comment.getCommentId() = 196999227472322566
        comment.getCommentId() = 196999227472322567
        comment.getCommentId() = 196999227472322568
        comment.getCommentId() = 196999227472322569
	*/
